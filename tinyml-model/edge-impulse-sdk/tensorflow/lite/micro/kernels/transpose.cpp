  ...
  switch (input->type) {
    case kTfLiteFloat32:
      reference_ops::Transpose(
          params, tflite::micro::GetTensorShape(input), input->data.f,
          tflite::micro::GetTensorShape(output), output->data.f);
      break;
    case kTfLiteInt8:
      reference_ops::Transpose(
          params, tflite::micro::GetTensorShape(input), input->data.int8,
          tflite::micro::GetTensorShape(output), output->data.int8);
      break;
    case kTfLiteInt32:
      reference_ops::Transpose(
          params, tflite::micro::GetTensorShape(input), input->data.i32,
          tflite::micro::GetTensorShape(output), output->data.i32);
      break;
    default:
