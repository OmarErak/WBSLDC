...
class MicroMutableOpResolver : public MicroOpResolver {
 public:
  ...
  TfLiteStatus AddImag() {
    return AddBuiltin(BuiltinOperator_IMAG, Register_IMAG(), ParseImag);
  }
  ...
  TfLiteStatus AddReal() {
    return AddBuiltin(BuiltinOperator_REAL, Register_REAL(), ParseReal);
  }
  ...
  TfLiteStatus AddRfft2D() {
    return AddBuiltin(BuiltinOperator_RFFT2D, Register_RFFT2D(), ParseRfft2D);
  }
  ...
  TfLiteStatus AddSelect() {
    return AddBuiltin(BuiltinOperator_SELECT, Register_SELECT(), ParseSelect);
  }
  ...
  TfLiteStatus AddSquaredDifference() {
    return AddBuiltin(BuiltinOperator_SQUARED_DIFFERENCE,
                      Register_SQUARED_DIFFERENCE(), ParseSquaredDifference);
  }
  ...
  TfLiteStatus AddTranspose() {
    return AddBuiltin(BuiltinOperator_TRANSPOSE, tflite::Register_TRANSPOSE(),
                      ParseTranspose);
  }
