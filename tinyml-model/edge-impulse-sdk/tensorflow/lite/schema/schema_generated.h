...
inline const char *const *EnumNamesBuiltinOperator() {
  static const char *const names[141] = {"ADD",
                                         "AVERAGE_POOL_2D",
                                         "CONCATENATION",
                                         "CONV_2D",
                                         "DEPTHWISE_CONV_2D",
...
inline const char *const *EnumNamesBuiltinOptions() {
  static const char *const names[112] = {"NONE",
                                         "Conv2DOptions",
...
inline flatbuffers::Offset<SignatureDef> CreateSignatureDefDirect(
    ...
    const std::vector<flatbuffers::Offset<tflite::TensorMap>> *outputs =
        nullptr,
    const char *method_name = nullptr, const char *key = nullptr) {
  auto inputs__ =
      inputs
  ...
  return tflite::CreateSignatureDef(_fbb, inputs__, outputs__, method_name__,
                                    key__);
}
...
inline flatbuffers::Offset<SignatureDef> CreateSignatureDef(
  ...
  auto _outputs =
      _o->outputs.size()
          ...
          : 0;
  auto _method_name =
      _o->method_name.empty() ? 0 : _fbb.CreateString(_o->method_name);
  auto _key = _o->key.empty() ? 0 : _fbb.CreateString(_o->key);
  return tflite::CreateSignatureDef(_fbb, _inputs, _outputs, _method_name,
                                    _key);
}
