 ...
 * @copydoc cropImage(
    ...
    int iBpp)
 */
void crop_image_rgb888_packed(const uint8_t *srcImage, int srcWidth,
 ...
 */
void resize_image(const uint8_t *srcImage, int srcWidth, int srcHeight,
                  uint8_t *dstImage, int dstWidth, int dstHeight,
                  int pixel_size_B);
 ...
 */
void crop_and_interpolate_rgb888(const uint8_t *srcImage, int srcWidth,
