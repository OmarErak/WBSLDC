...
class kissfft {
 public:
  ...
  kissfft(const std::size_t nfft, const bool inverse)
    ...
    const scalar_t phinc =
        (_inverse ? 2 : -2) * std::acos((scalar_t)-1) / _nfft;
  ...
  void transform_real(const scalar_t *const src, cpx_t *const dst) const {
    ...
    dst[0] =
        cpx_t(dst[0].real() + dst[0].imag(), dst[0].real() - dst[0].imag());
    ...
    if (N % 2 == 0) dst[N / 2] = std::conj(dst[N / 2]);
  }
 ...
 private:
  ...
  void kf_bfly3(cpx_t *Fout, const std::size_t fstride,
    ...
    do {
      ...
      Fout[m2] = cpx_t(Fout[m].real() + scratch[0].imag(),
  ...
  void kf_bfly4(cpx_t *const Fout, const std::size_t fstride,
                const std::size_t m) const {
    cpx_t scratch[7];
  ...
  void kf_bfly5(cpx_t *const Fout, const std::size_t fstride,
                const std::size_t m) const {
    ...
    for (std::size_t u = 0; u < m; ++u) {
      ...
      *Fout0 += scratch[8];
      ...
      scratch[5] =
          scratch[0] +
          cpx_t(scratch[7].real() * ya.real() + scratch[8].real() * yb.real(),
      ...
      *Fout4 = scratch[5] + scratch[6];
      ...
      scratch[11] =
          scratch[0] +
          cpx_t(scratch[7].real() * yb.real() + scratch[8].real() * ya.real(),
                scratch[7].imag() * yb.real() + scratch[8].imag() * ya.real());

      scratch[12] =
          cpx_t(-scratch[10].imag() * yb.imag() + scratch[9].imag() * ya.imag(),
  ...
  void kf_bfly_generic(cpx_t *const Fout, const size_t fstride,
