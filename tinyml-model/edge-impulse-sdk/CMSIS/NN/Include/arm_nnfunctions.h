 ...
 * @param[in]      fc_params      Fully Connected layer parameters (e.g.
 * strides, dilations, pads,...) Range of fc_params->input_offset  : [-127, 128]
 *                                Range of fc_params->filter_offset : [-127,
 * 128] Range of fc_params->output_offset : [-128, 127]
