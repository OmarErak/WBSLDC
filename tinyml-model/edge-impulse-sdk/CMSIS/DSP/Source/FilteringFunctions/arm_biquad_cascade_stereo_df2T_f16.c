  ...
  do {
    ...
    *(f16x8_t *)scratch = *(f16x8_t *)pState;
    ...
    while (sample > 0U) {
       ...
       */
      stateVec0 =
          vldrhq_gather_shifted_offset((float16_t const *)scratch, loadIdxVec);
      /*
      ...
      *pOut++ = vgetq_lane(stateVec0, 1);
       ...
       */
      stateVec1 = vldrhq_gather_shifted_offset((float16_t const *)scratch,
                                               reshufledIdxVec);
...
#endif /* #if defined(ARM_MATH_MVE_FLOAT16) && \
