...
__STATIC_FORCEINLINE arm_status arm_mat_mult_f16_2x2_mve(
   ...
   */
  vecInA =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcA->pData, vecOffsA);
  /*
   * load {b00 b01 b00 b01 x x x x }
   */
  vecInB =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcB->pData, vecOffsB);
  /*
   *  { a00 b00       a00 b01
   *    a10 b00       a10 b01
   *       x             x
...
__STATIC_FORCEINLINE arm_status arm_mat_mult_f16_3x3_mve(
  ...
  vecInB =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcB->pData, vecOffsB);
  /*
   *  {a00 b00 + a01 b10 + a02 b20  a00 b01 + a01 b11 + a02 b21     a00 b02 +
   * a01 b12 + a02 b22}, a10 b00 + a11 b10 + a12 b20    a10 b01 + a11 b11 + a12
   * b21     a10 b02 + a11 b12 + a12 b22}, a20 b00 + a21 b10 + a22 b20    a20
   * b01 + a21 b11 + a22 b21   }
   */
  vecDst = vfmaq(vecDst, vecInA, vecInB);
  ...
  *pOut = pA[2 * 3] * pB[2] + pA[2 * 3 + 1] * pB[3 + 2] +
          pA[2 * 3 + 2] * pB[2 * 3 + 2];
...
__STATIC_FORCEINLINE arm_status arm_mat_mult_f16_4x4_mve(
  ...
  vecInB =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcB->pData, vecOffsB);
  /*
   *  { a00 b00 + a01 b10         a00 b01 + a01 b11       a00 b02 + a01 b12 a00
   * b03 + a01 b13 a10 b00 + a11 b10         a10 b01 + a11 b11       a10 b02 +
   * a11 b12       a10 b03 + a11 b13 }
   */
  ...
  vecInA =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcA->pData, vecOffsA);
  /*
   *  {a20 b00 + a21 b10      a20 b01 + a21 b11       a20 b02 + a21 b12 a20 b03
   * + a21 b13 a30 b00 + a31 b10      a30 b01 + a31 b11       a30 b02 + a31 b12
   * a30 b03 + a31 b13 }
   */
  ...
  /*
   *  { a00 b00 + a01 b10 + a02 b20    a00 b01 + a01 b11 + a02 b21    a00 b02 +
   * a01 b12 + a02 b22   a00 b03 + a01 b13 + a02 b23 a10 b00 + a11 b10 + a12 b20
   * a10 b01 + a11 b11 + a12 b21    a10 b02 + a11 b12 + a12 b22   a10 b03 + a11
   * b13 + a12 b23 }
   */
  vecDst0 = vfmaq(vecDst0, vecInA, vecInB);
  /*
  ...
  vecInA =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcA->pData, vecOffsA);
  /*
   *  {a20 b00 + a21 b10 + a22 b20   a20 b01 + a21 b11 + a22 b21  a20 b02 + a21
   * b12 + a22 b22    a20 b03 + a21 b13 + a22 b23 a30 b00 + a31 b10 + a32 b20
   * a30 b01 + a31 b11 + a32 b21  a30 b02 + a31 b12 + a32 b22    a30 b03 + a31
   * b13 + a32 b23 }
   */
  vecDst1 = vfmaq(vecDst1, vecInA, vecInB);
  ...
  vecInB =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcB->pData, vecOffsB);
  /*
   * { a00 b00 +...+ a03 b30,    a00 b01 +...+ a03 b31,   a00 b02 +...+ a03 b32,
   * a00 b03 +...+ a03 b33 a10 b00 +...+ a13 b30,    a10 b01 +...+ a13 b31, a10
   * b02 +...+ a13 b32,   a10 b03 +...+ a13 b33 }
   */
  vecDst0 = vfmaq(vecDst0, vecInA, vecInB);
  /*
   * jump 2 x A rows
  ...
  vecInA =
      vldrhq_gather_shifted_offset((float16_t const *)pSrcA->pData, vecOffsA);
  /*
   *  {a20 b00 +...+ a23 b30,   a20 b01 +...+ a23 b31,   a20 b02 +...+ a23 b32,
   * a20 b03 +...+ a23 b33 a30 b00 +...+ a33 b30,   a30 b01 +...+ a33 b31,   a30
   * b02 +...+ a33 b32,   a30 b03 +...+ a33 b33 }
   */
  vecDst1 = vfmaq(vecDst1, vecInA, vecInB);
