...
static void arm_bitreversal_f32_inpl_mve(uint32_t *pSrc,
...
static void _arm_radix4_butterfly_f32_mve(const arm_cfft_instance_f32 *S,
                                          float32_t *pSrc, uint32_t fftLen) {
...
static void arm_cfft_radix4by2_f32_mve(const arm_cfft_instance_f32 *S,
                                       float32_t *pSrc, uint32_t fftLen) {
...
static void _arm_radix4_butterfly_inverse_f32_mve(
    const arm_cfft_instance_f32 *S, float32_t *pSrc, uint32_t fftLen,
...
static void arm_cfft_radix4by2_inverse_f32_mve(const arm_cfft_instance_f32 *S,
                                               float32_t *pSrc,
                                               uint32_t fftLen) {
  float32_t const *pCoefVec;
  float32_t const *pCoef = S->pTwiddle;
...
void arm_cfft_f32(const arm_cfft_instance_f32 *S, float32_t *pSrc,
  ...
  if (bitReverseFlag) {
    arm_bitreversal_f32_inpl_mve((uint32_t *)pSrc, S->bitRevLength,
                                 S->pBitRevTable);
  }
}
