 ...
 * Description:  Split Radix Decimation in Frequency CFFT Double Precision
...
/**
  @brief         Initialization function for the 32pt double precision
...
/**
  @brief         Initialization function for the 64pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the 128pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the 256pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the 512pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the 1024pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the 2048pt Double Precision
  floating-point real FFT.
  @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
* @brief         Initialization function for the 4096pt Double Precision
floating-point real FFT.
* @param[in,out] S  points to an arm_rfft_fast_instance_f64 structure
  @return        execution status
                   - \ref ARM_MATH_SUCCESS        : Operation successful
...
/**
  @brief         Initialization function for the Double Precision floating-point
  real FFT.
  @param[in,out] S       points to an arm_rfft_fast_instance_f64 structure
