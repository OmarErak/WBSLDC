...
arm_status arm_cfft_radix4by2_rearrange_twiddles_q15(arm_cfft_instance_q15 *S,
  ...
  switch (S->fftLen >> (twidCoefModifier - 1)) {
    ...
    case 1024U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_1024_q15;
      S->rearranged_twiddle_stride1 = rearranged_twiddle_stride1_1024_q15;

      S->rearranged_twiddle_tab_stride2_arr =
          rearranged_twiddle_tab_stride2_arr_1024_q15;
      S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_1024_q15;

      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_1024_q15;
    ...
    case 256U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_256_q15;
      S->rearranged_twiddle_stride1 = rearranged_twiddle_stride1_256_q15;

      S->rearranged_twiddle_tab_stride2_arr =
          rearranged_twiddle_tab_stride2_arr_256_q15;
      S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_256_q15;

      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_256_q15;
    ...
    case 64U:
      ...
      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_64_q15;
