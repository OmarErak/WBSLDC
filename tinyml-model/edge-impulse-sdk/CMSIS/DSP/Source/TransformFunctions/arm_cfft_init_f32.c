...
arm_status arm_cfft_radix4by2_rearrange_twiddles_f32(arm_cfft_instance_f32 *S,
  ...
  switch (S->fftLen >> (twidCoefModifier - 1)) {
    ...
    case 4096U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_4096_f32;
      ...
      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_4096_f32;
    ...
    case 1024U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_1024_f32;
      ...
      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_1024_f32;
