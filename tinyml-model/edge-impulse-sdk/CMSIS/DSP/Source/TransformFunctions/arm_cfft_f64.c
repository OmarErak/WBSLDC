 ...
 * Description:  Combined Radix Decimation in Frequency CFFT Double Precision
...
extern void arm_radix4_butterfly_f64(float64_t* pSrc, uint16_t fftLen,
...
void arm_cfft_radix4by2_f64(float64_t* pSrc, uint32_t fftLen,
                            const float64_t* pCoef) {
  uint32_t i, l;
  uint32_t n2, ia;
