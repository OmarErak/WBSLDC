...
/**
  ...
  @param[in,out] S              points to an instance of the floating-point CFFT
  structure
  ...
  @par          Use of this function is mandatory only for the MVE version of
  the FFT. Other versions can still initialize directly the data structure using
...
arm_status arm_cfft_radix4by2_rearrange_twiddles_f16(arm_cfft_instance_f16 *S,
  ...
  switch (S->fftLen >> (twidCoefModifier - 1)) {
    ...
    case 1024U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_1024_f16;
      S->rearranged_twiddle_stride1 = rearranged_twiddle_stride1_1024_f16;

      S->rearranged_twiddle_tab_stride2_arr =
          rearranged_twiddle_tab_stride2_arr_1024_f16;
      S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_1024_f16;

      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_1024_f16;
    ...
    case 256U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_256_f16;
      S->rearranged_twiddle_stride1 = rearranged_twiddle_stride1_256_f16;

      S->rearranged_twiddle_tab_stride2_arr =
          rearranged_twiddle_tab_stride2_arr_256_f16;
      S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_256_f16;

      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_256_f16;
    ...
    case 64U:
      ...
      S->rearranged_twiddle_tab_stride2_arr =
          rearranged_twiddle_tab_stride2_arr_64_f16;
      S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_64_f16;

      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_64_f16;
    ...
    case 16U:
      S->rearranged_twiddle_tab_stride1_arr =
          rearranged_twiddle_tab_stride1_arr_16_f16;
      ...
      S->rearranged_twiddle_tab_stride3_arr =
          rearranged_twiddle_tab_stride3_arr_16_f16;
