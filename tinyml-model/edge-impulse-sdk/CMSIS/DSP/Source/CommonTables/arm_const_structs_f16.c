...
/*
ALLOW TABLE is true when config table is enabled and the Tramsform folder is
...
Those structures cannot be used to initialize the MVE version of the FFT F32
instances. So they are not compiled when MVE is defined.
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len16 = {
    16, twiddleCoefF16_16, armBitRevIndexTable_fixed_16,
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len32 = {
    32, twiddleCoefF16_32, armBitRevIndexTable_fixed_32,
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len64 = {
    64, twiddleCoefF16_64, armBitRevIndexTable_fixed_64,
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len128 = {
    128, twiddleCoefF16_128, armBitRevIndexTable_fixed_128,
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len256 = {
    256, twiddleCoefF16_256, armBitRevIndexTable_fixed_256,
...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len512 = {
    512, twiddleCoefF16_512, armBitRevIndexTable_fixed_512,
