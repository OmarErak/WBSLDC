...
static void arm_bitonic_sort_core_f32(float32_t *pSrc, uint32_t n,
                                      uint8_t dir) {
  uint32_t step;
  uint32_t k, j;
...
static float32x4x2_t arm_bitonic_resort_8_f32(float32x4_t a, float32x4_t b,
                                              uint8_t dir) {
...
static float32x4x2_t arm_bitonic_merge_8_f32(float32x4_t a, float32x4_t b,
                                             uint8_t dir) {
...
static void arm_bitonic_resort_16_f32(float32_t *pOut, float32x4x2_t a,
                                      float32x4x2_t b, uint8_t dir) {
  /* Start with two vectors:
   * +---+---+---+---+---+---+---+---+
   * | a | b | c | d | e | f | g | h |
   * +---+---+---+---+---+---+---+---+
...
static void arm_bitonic_merge_16_f32(float32_t *pOut, float32x4x2_t a,
                                     float32x4x2_t b, uint8_t dir) {
...
static void arm_bitonic_sort_16_f32(float32_t *pSrc, float32_t *pDst,
                                    uint8_t dir) {
  float32x4_t a;
  float32x4_t b;
  float32x4_t c;
...
static void arm_bitonic_merge_32_f32(float32_t *pSrc, float32x4x2_t ab1,
                                     float32x4x2_t ab2, float32x4x2_t cd1,
                                     float32x4x2_t cd2, uint8_t dir) {
  // Compare
  if (dir) {
    vminmax256q(ab1, cd1);
    vminmax256q(ab2, cd2);
...
static float32x4x2_t arm_bitonic_sort_8_f32(float32x4_t a, float32x4_t b,
                                            uint8_t dir) {
 ...
 */
void arm_bitonic_sort_f32(const arm_sort_instance_f32 *S, float32_t *pSrc,
