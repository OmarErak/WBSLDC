...
#define MVE_INTR_CORR_QUAD_INC_X_FIXED_SIZE_F32(acc0, acc1, acc2, acc3, pX, \
                                                pY, count)                  \
  {                                                                         \
...
#define MVE_INTR_CONV_QUAD_INC_X_FIXED_SIZE_Q31(acc0, acc1, acc2, acc3, pX, \
                                                pY, count)                  \
  {                                                                         \
    q31_t const *pSrcX;                                                     \
    q31x4_t xVec, yVec;                                                     \
...
#define MVE_INTR_CORR_QUAD_INC_X_FIXED_SIZE_Q31(acc0, acc1, acc2, acc3, pX, \
                                                pY, count)                  \
  {                                                                         \
    q31_t const *pSrcX, *pSrcY;                                             \
    q31x4_t xVec, yVec;                                                     \
...
#define MVE_INTR_CORR_QUAD_INC_X_FIXED_SIZE_Q15(acc0, acc1, acc2, acc3, pX, \
                                                pY, count)                  \
  {                                                                         \
    q15_t const *pSrcX, *pSrcY;                                             \
    q15x8_t xVec, yVec;                                                     \
...
#define MVE_INTR_CONV_QUAD_INC_X_FIXED_SIZE_Q15(acc0, acc1, acc2, acc3, pX, \
                                                pY, count)                  \
  {                                                                         \
    q15_t const *pSrcX;                                                     \
    q15x8_t xVec, yVec;                                                     \
...
#define MVE_INTR_CORR_QUAD_INC_X_FIXED_SIZE_Q7(acc0, acc1, acc2, acc3, pX, pY, \
                                               count)                          \
  {                                                                            \
    q7_t const *pSrcX, *pSrcY;                                                 \
    q7x16_t xVec, yVec;                                                        \
...
#define MVE_INTR_CONV_QUAD_INC_X_FIXED_SIZE_Q7(acc0, acc1, acc2, acc3, pX, pY, \
                                               count)                          \
  {                                                                            \
    q7_t const *pSrcX;                                                         \
    q7x16_t xVec, yVec;                                                        \
