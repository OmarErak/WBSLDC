 ...
 *
 */
float16_t arm_correlation_distance_f16(float16_t *pA, float16_t *pB,
                                       uint32_t blockSize);
...
float16_t arm_cosine_distance_f16(const float16_t *pA, const float16_t *pB,
                                  uint32_t blockSize);
...
float16_t arm_minkowski_distance_f16(const float16_t *pA, const float16_t *pB,
