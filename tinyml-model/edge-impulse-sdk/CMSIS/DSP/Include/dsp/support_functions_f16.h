 ...
 * @param[in]  blockSize  length of the input vector
 */
void arm_float_to_f16(const float32_t *pSrc, float16_t *pDst,
                      uint32_t blockSize);
 ...
 * @param[in]  blockSize  length of the input vector
 */
void arm_f16_to_float(const float16_t *pSrc, float32_t *pDst,
                      uint32_t blockSize);
 ...
 *
 */
void arm_barycenter_f16(const float16_t *in, const float16_t *weights,
                        float16_t *out, uint32_t nbVectors, uint32_t vecDim);
