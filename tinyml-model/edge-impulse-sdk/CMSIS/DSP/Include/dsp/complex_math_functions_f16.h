 ...
 */
void arm_cmplx_conj_f16(const float16_t* pSrc, float16_t* pDst,
                        uint32_t numSamples);
 ...
 */
void arm_cmplx_mag_squared_f16(const float16_t* pSrc, float16_t* pDst,
                               uint32_t numSamples);
 ...
 * @param[in]  numSamples  number of complex samples in the input vector
 */
void arm_cmplx_mag_f16(const float16_t* pSrc, float16_t* pDst,
                       uint32_t numSamples);
 ...
 */
void arm_cmplx_dot_prod_f16(const float16_t* pSrcA, const float16_t* pSrcB,
...
void arm_cmplx_mult_real_f16(const float16_t* pSrcCmplx,
                             const float16_t* pSrcReal, float16_t* pCmplxDst,
                             uint32_t numSamples);
 ...
 * @param[in]  numSamples  number of complex samples in each vector
 */
void arm_cmplx_mult_cmplx_f16(const float16_t* pSrcA, const float16_t* pSrcB,
