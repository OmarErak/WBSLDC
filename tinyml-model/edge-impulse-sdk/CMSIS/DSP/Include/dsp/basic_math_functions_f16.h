 ...
 */
void arm_add_f16(const float16_t* pSrcA, const float16_t* pSrcB,
 ...
 * @param[in]  blockSize  number of samples in each vector
 */
void arm_sub_f16(const float16_t* pSrcA, const float16_t* pSrcB,
                 float16_t* pDst, uint32_t blockSize);
 ...
 */
void arm_scale_f16(const float16_t* pSrc, float16_t scale, float16_t* pDst,
                   uint32_t blockSize);
 ...
 */
void arm_dot_prod_f16(const float16_t* pSrcA, const float16_t* pSrcB,
 ...
 * @param[in]  blockSize  number of samples in each vector
 */
void arm_mult_f16(const float16_t* pSrcA, const float16_t* pSrcB,
                  float16_t* pDst, uint32_t blockSize);
...
void arm_clip_f16(const float16_t* pSrc, float16_t* pDst, float16_t low,
                  float16_t high, uint32_t numSamples);
