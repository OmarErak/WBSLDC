 ...
 */
void arm_power_f16(const float16_t *pSrc, uint32_t blockSize,
                   float16_t *pResult);
 ...
 * @param[out] pResult    is output value.
 */
void arm_mean_f16(const float16_t *pSrc, uint32_t blockSize,
                  float16_t *pResult);
...
float16_t arm_logsumexp_dot_prod_f16(const float16_t *pSrcA,
                                     const float16_t *pSrcB, uint32_t blockSize,
...
/**
    ...
    @return        none
   */
void arm_max_no_idx_f16(const float16_t *pSrc, uint32_t blockSize,
                        float16_t *pResult);
