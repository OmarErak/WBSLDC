...
#include <version.h>
    ...
    ((KERNEL_VERSION_MAJOR == 3) && (KERNEL_VERSION_MINOR > 0))
...
uint64_t ei_read_timer_ms() { return k_uptime_get(); }

uint64_t ei_read_timer_us() { return k_uptime_get() * 1000; }
...
__attribute__((weak)) void ei_printf_float(float f) { printf("%f", f); }
