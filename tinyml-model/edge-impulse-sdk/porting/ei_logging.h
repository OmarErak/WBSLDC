...
extern "C"
    ...
    const char *debug_msgs[] = {"NONE",  // this one will never show
...
#undef EI_LOGE
#endif  // EI_LOGE
#define EI_LOGE(format, ...)                         \
  ei_printf("%s: ", debug_msgs[EI_LOG_LEVEL_ERROR]); \
  ei_printf(format, ##__VA_ARGS__);
#endif
...
#undef EI_LOGW
#endif  // EI_LOGW
#define EI_LOGW(format, ...)                           \
  ei_printf("%s: ", debug_msgs[EI_LOG_LEVEL_WARNING]); \
  ei_printf(format, ##__VA_ARGS__);
#endif
...
#undef EI_LOGI
#endif  // EI_LOGI
#define EI_LOGI(format, ...)                        \
  ei_printf("%s: ", debug_msgs[EI_LOG_LEVEL_INFO]); \
  ei_printf(format, ##__VA_ARGS__);
#endif
...
#undef EI_LOGD
#endif  // EI_LOGD
#define EI_LOGD(format, ...)                         \
  ei_printf("%s: ", debug_msgs[EI_LOG_LEVEL_DEBUG]); \
  ei_printf(format, ##__VA_ARGS__);
#endif
