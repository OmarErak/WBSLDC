...
uint64_t ei_read_timer_ms() { return millis(); }

uint64_t ei_read_timer_us() { return micros(); }

void ei_serial_set_baudrate(int baudrate) {}

EI_WEAK_FN void ei_putchar(char c) { Serial.write(c); }
...
__attribute__((weak)) void ei_printf_float(float f) { Serial.print(f, 6); }
