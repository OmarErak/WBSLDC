...
static void systick_isr(void) { tick++; }
...
uint64_t ei_read_timer_us() { return ei_read_timer_ms() * 1000; }

void ei_putchar(char c) { putchar(c); }

__attribute__((weak)) char ei_getchar(void) { return getchar(); }
...
__attribute__((weak)) void ei_printf_float(float f) { ei_printf("%f", f); }
