...
uint64_t ei_read_timer_ms() { return get_time_ms(); }

uint64_t ei_read_timer_us() { return get_time_ms() * 1000; }
...
__attribute__((weak)) void ei_putchar(char c) { uart_putchar(c); }
...
__attribute__((weak)) void *ei_malloc(size_t size) { return os_Malloc(size); }

__attribute__((weak)) void *ei_calloc(size_t nitems, size_t size) {
  return os_Malloc(nitems * size);
}

__attribute__((weak)) void ei_free(void *ptr) { os_Free(ptr); }
