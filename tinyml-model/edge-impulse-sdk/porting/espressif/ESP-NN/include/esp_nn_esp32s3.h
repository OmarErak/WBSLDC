 ...
 */
void esp_nn_add_elementwise_s8_esp32s3(
 ...
 */
void esp_nn_mul_elementwise_s8_esp32s3(
    const int8_t *input1_data, const int8_t *input2_data,
...
void esp_nn_depthwise_conv_s8_esp32s3(
    ...
    const int32_t *bias, const data_dims_t *output_dims, int8_t *output_data,
 ...
 * [-128, 127]
 */
void esp_nn_max_pool_s8_esp32s3(
    const int8_t *input, const uint16_t input_wd, const uint16_t input_ht,
    int8_t *output, const uint16_t output_wd, const uint16_t output_ht,
    const uint16_t stride_wd, const uint16_t stride_ht,
    const uint16_t filter_wd, const uint16_t filter_ht, const uint16_t pad_wd,
    const uint16_t pad_ht, const int32_t activation_min,
 ...
 * [-128, 127]
 */
void esp_nn_avg_pool_s8_esp32s3(
    const int8_t *input, const uint16_t input_wd, const uint16_t input_ht,
    int8_t *output, const uint16_t output_wd, const uint16_t output_ht,
    const uint16_t stride_wd, const uint16_t stride_ht,
    const uint16_t filter_wd, const uint16_t filter_ht, const uint16_t pad_wd,
 ...
 */
void esp_nn_fully_connected_s8_esp32s3(
...
#define esp_nn_set_depthwise_conv_scratch_buf \
